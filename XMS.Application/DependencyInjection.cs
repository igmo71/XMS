...
using XMS.Integrations.OneC.Buh.Api;
using XMS.Integrations.OneC.Buh.ODataClient;
using XMS.Integrations.OneC.Common;
using XMS.Integrations.OneC.Ut.Api;
using XMS.Integrations.OneC.Ut.Features.Catalog_КонтактныеЛицаПартнеров_Feature;
using XMS.Integrations.OneC.Ut.Features.Catalog_Контрагенты_Feature;
using XMS.Integrations.OneC.Ut.Features.Catalog_Номенклатура_Feature;
using XMS.Integrations.OneC.Ut.Features.Catalog_Партнеры_Feature;
...
using XMS.Integrations.OneC.Ut.Features.Document_ЗаказКлиента_Feature;
using XMS.Integrations.OneC.Ut.Features.Document_РасходныйКассовыйОрдер_Feature;
using XMS.Integrations.OneC.Ut.Features.Document_РеализацияТоваровУслуг_Feature;
...
using XMS.Integrations.OneC.Zup.Api;
