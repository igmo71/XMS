...
public static class DependencyInjection
{
    public static IServiceCollection AddUtCServices(this IServiceCollection services)
    {
        ...
        services.AddHostedService<Catalog_КСЗ_КатегорииЗатрат_EventConsumer>();
        services.AddScoped<ICatalog_КСЗ_КатегорииЗатрат_EventHandler, Catalog_КСЗ_КатегорииЗатрат_EventHandler>();
        ...
        services.AddHostedService<Catalog_Пользователи_EventConsumer>();
        services.AddScoped<ICatalog_Пользователи_EventHandler, Catalog_Пользователи_EventHandler>();
