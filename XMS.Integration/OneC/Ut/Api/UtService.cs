...
namespace XMS.Integration.OneC.Ut.Api;
    ...
    IDocument_СписаниеБезналичныхДенежныхСредств_Service document_СписаниеБезналичныхДенежныхСредств_Service) : IOneCUtService
{
    ...
    {
        var rootObject = await utClient.GetValueFromJsonAsync<RootObject<Catalog_Пользователи>>(
            IntegrationHelper.GetUri<Catalog_Пользователи>(), ct);
