...
public record Document_РасходныйКассовыйОрдер_Received : IIntegrationEvent
{
    ...
    public static Document_РасходныйКассовыйОрдер_Received From(Document_РасходныйКассовыйОрдер source) =>
        new()
        {
