...
using Handler = XMS.Integration.OneC.Ut.Abstractions.ICatalog_Контрагенты_EventHandler;

namespace XMS.Integration.OneC.Ut.Features.Catalog_Контрагенты_Feature;

internal class Catalog_Контрагенты_EventConsumer(
    IConnectionFactory factory,
    IServiceProvider serviceProvider,
    IHostEnvironment hostEnvironment,
    ILogger<Catalog_Контрагенты_EventConsumer> logger)
