...
public static class Document_РеализацияТоваровУслуг_Endpoint
{
    ...
    {
        string feature = nameof(Document_РеализацияТоваровУслуг);
        ...
        extGroup.MapPatch("/notify", DocumentPublisher.PublishAsync<Document_РеализацияТоваровУслуг_Notification>)
