...
public class Document_ЗаказКлиента : IDocument
{
    ...
    public static string Uri => "Document_ЗаказКлиента?$format=json&$inlinecount=allpages" +
    ...
    public static string GetExchangeName(IHostEnvironment hostEnvironment) =>
        hostEnvironment.IsDevelopment() ? $"dev_{nameof(Document_ЗаказКлиента)}" : $"{nameof(Document_ЗаказКлиента)}";

    public static string GetQueueName(IHostEnvironment hostEnvironment) =>
        hostEnvironment.IsDevelopment() ? $"dev_{nameof(Document_ЗаказКлиента)}" : $"xms_{nameof(Document_ЗаказКлиента)}";
