...
public record Document_СписаниеБезналичныхДенежныхСредств_Received : IIntegrationEvent
{
    ...
    public string? НазначениеПлатежа { get; init; }
    ...
    public static Document_СписаниеБезналичныхДенежныхСредств_Received From(Document_СписаниеБезналичныхДенежныхСредств source) =>
        new()
        {
