...
using DeletedEvent = XMS.EventBus.Events.Document_СписаниеБезналичныхДенежныхСредств_Deleted;
...
using ReceivedEvent = XMS.EventBus.Events.Document_СписаниеБезналичныхДенежныхСредств_Received;
