...
public record Document_СписаниеБезналичныхДенежныхСредств_Deleted : IIntegrationEvent
{
    ...
    public static Document_СписаниеБезналичныхДенежныхСредств_Deleted From(Document_СписаниеБезналичныхДенежныхСредств source) =>
        new()
        {
